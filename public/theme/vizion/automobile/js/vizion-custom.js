           ...
           jQuery('.iq-accordion .iq-accordion-block .accordion-details').hide();
                ...
                jQuery('.iq-accordion .iq-accordion-block').on("click", function() {
                    if (jQuery(this).children('div').is(':hidden')) {
                        jQuery('.iq-accordion .iq-accordion-block').removeClass('accordion-active').children('div').slideUp('slow');
                        jQuery(this).toggleClass('accordion-active').children('div').slideDown('slow');
                    }
                });
