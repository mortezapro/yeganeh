            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title d-inline-block">لیست پست ها</h4>
                        <a href="{{ route("admin.posts.create") }}" class="btn btn-primary btn-rounded waves-effect waves-light d-inline-block mr-3">
