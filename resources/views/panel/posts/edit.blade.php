...
@section("head")
    ...
    <title>فنجان ایرانی | ویرایش پست</title>
@endsection
@section("content")
    <div class="content">
        <form action="{{ route("admin.posts.store",["post" => $post->slug]) }}" method="post" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a href="#main" data-bs-toggle="tab" class="nav-link active">
                                            اصلی
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#seo" data-bs-toggle="tab" class="nav-link">
                                            سئو
                                        </a>
                                    </li>
                                </ul>
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <select name="category[]" id="category" class="form-control" multiple>
                                                    @foreach($categories as $item)
                                                        <option @if($post->categories->contains($item)) selected @endif value="{{ $item->id }}">{{ $item->title }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="btn-group">
                                        <input value="{{config("post-status.published")}}" type="radio" class="btn-check" name="status" id="status1" @if($post->stataus == "منتشر شده") checked @endif checked>
                                        <label class="btn btn-outline-primary" for="status1">منتشر شده</label>
                                        <input value="{{config("post-status.disabled")}}" type="radio" class="btn-check" name="status" id="status2" @if($post->status == "غیر فعال") checked @endif>
