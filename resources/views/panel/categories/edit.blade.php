...
@section("head")
    ...
    <title>فنجان ایرانی | ویرایش دسته {{ $category->title }}</title>
@endsection
@section("content")
    <div class="content">
        <form action="{{ route("admin.categories.store",["category" => $category->slug]) }}" method="post" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title d-inline-block">ایجاد دسته جدید</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="main">
                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                                <label for="title" class="form-label">نام دسته</label>
                                            ...
                                            <div class="col-md-12 mb-3">
                                                <label for="parent" class="form-label">والد (پدر)</label>
                                                <select name="parent[]" id="parent" class="form-control" multiple>
                                                    @foreach($categories as $item)
                                                        <option @if($category->categories->contains($item)) selected @endif  value="{{ $item->id }}">{{ $item->title }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-md-12 mb-3">
                                    ...
                                    <div class="tab-pane" id="seo">
                                        ...
                                        <div class="mb-3">
                                            <input class="form-check-input rounded-circle" type="checkbox" name="indexable" id="indexable" value="1" @if($category->indexable == "بله") checked @endif>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="gallery-preview d-flex justify-content-center" id="thumbnail-preview">
                                    <img class="gallery-preview-item" src="{{ asset("category-thumbnails/default/")."/".$category->thumbnail }}">
                                </div>
                                <div class="mb-3">
