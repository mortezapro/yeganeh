            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title d-inline-block">لیست دسته ها</h4>
                        <a href="{{ route("admin.categories.create") }}" class="btn btn-primary btn-rounded waves-effect waves-light d-inline-block mr-3">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title uc-first">حذف دسته</h5>
