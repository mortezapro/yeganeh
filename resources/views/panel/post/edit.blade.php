...
<title>لیست پست ها | {{ env("APP_NAME") }}</title>
@section("head")
@endsection
@section("content")
    <div class="container-fluid">
        ...
        <div class="row">
            <form action="{{ route("panel.posts.update",["post"=> $post->slug]) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="container-fluid">
                    <div class="row">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <select name="category[]" id="category" class="form-control" multiple>
                                                        @foreach($categories as $category)
                                                            <option @if($post->categories->contains($category)) selected @endif value="{{ $category->id }}">{{ $category->title }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                        ...
                                        <div class="tab-pane" id="seo">
                                            <div class="row">
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="text" name="canonical" id="canonical" class="form-control" value="{{ old("canonical",$post->canonical) }}">
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                ...
                                                <div class="mb-3 col-md-12">
                                                    ...
                                                    <textarea type="text" name="seo_description" id="seo_description" class="form-control">{{ old("seo_description",$post->seo_description) }}</textarea>
                                                </div>
                                                <div class="gallery-preview d-flex justify-content-center" id="seo-image-preview">
                                                    <img class="gallery-preview-item" src="{{ asset("seo-images/default")."/".$post->seo_image }}">
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    <input class="form-check-input rounded-circle" type="checkbox" name="indexable" id="indexable" @if($post->indexable) checked @endif value="1" >
                            ...
                            <div class="card sticky-top">
                                <div class="card-body">
                                    <div class="gallery-preview d-flex justify-content-center" id="thumbnail-preview">
                                        <img class="gallery-preview-item" src="{{ asset("post-thumbnails/default")."/".$post->thumbnail }}">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="btn-group">
                                            <input value="{{config("post-status.published")}}" type="radio" class="btn-check" name="status" id="status1" @if($post->stataus == config("post-status.published")) checked @endif checked>
                                            <label class="btn btn-outline-primary" for="status1">انتشار</label>
                                            <input value="{{config("post-status.draft")}}" type="radio" class="btn-check" name="status" id="status2" @if($post->status == config("post-status.draft")) checked @endif>
