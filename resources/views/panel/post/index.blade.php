            ...
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <div class="page-title-left">
                        <h4 class="page-title d-inline me-2">لیست پست‌ها</h4>
                        <a href="{{ route("panel.posts.create") }}" class="btn btn-primary"><i class="fe-plus"></i> افزودن پست جدید</a>
                    </div>
