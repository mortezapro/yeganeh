            ...
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <div class="page-title-left">
                        <h4 class="page-title d-inline me-2">لیست دسته‌بندی‌ها</h4>
                        <a href="{{ route("panel.categories.create") }}" class="btn btn-primary"><i class="fe-plus"></i> افزودن دسته‌بندی‌ جدید</a>
                    </div>
...
@section("script")
    ...
    <script>
        ...
        var table = $('#datatable').DataTable({
            ...
            "scrollX": true,
            ajax: "{{ route('panel.categories.index') }}",
            columns: [
