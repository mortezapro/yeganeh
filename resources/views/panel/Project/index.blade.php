...
@section("head")
    <title>لیست پروژه‌ها | {{ env("APP_NAME") }}</title>
            ...
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <div class="page-title-left">
                        <h4 class="page-title d-inline me-2">لیست پروژه‌ها</h4>
                        <a href="{{ route("panel.projects.create") }}" class="btn btn-primary"><i class="fe-plus"></i> افزودن پروژه جدید</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title uc-first">حذف پروژه</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>پروژه حذف خواهد شد. آیا مطمئن هستید؟</p>
                </div>
...
@section("script")
    ...
    <script>
        ...
        var table = $('#datatable').DataTable({
            ...
            "scrollX": true,
            ajax: "{{ route('panel.projects.index') }}",
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'title', name: 'title'},
                {data: 'slug', name: 'slug'},
                {data: 'captionType', name: 'captionType'},
