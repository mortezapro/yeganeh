...
<link rel="stylesheet" href="{{ asset("panel/assets/libs/file-upload/css/fileInput.css") }}">
    <title>ایجاد پروژه جدید | {{ env("APP_NAME") }}</title>
@section("head")
@endsection
@section("content")
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">ایجاد پروژه جدید</li>
                        </ol>
                    </div>
                    <div class="page-title-left">
                        <h4 class="page-title d-inline me-2">افزودن پروژه جدید</h4>
                            ...
                            <div class="card sticky-top">
                                <div class="card-body">
                                    <div class="gallery-preview" id="thumbnail-preview">
                                        <img class="gallery-preview-item" src="{{ asset("project-thumbnails/default/thumbnail.png") }}">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <select name="type" id="project_type" class="form-control">
                                            <option selected value="{{ config("project-type.scan") }}">اسکن</option>
                                            <option value="{{ config("project-type.software") }}">نرم‌افزار</option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        <label for="status" class="form-label d-block mb-3">وضعیت</label>
                                        <div class="btn-group">
                                            <input value="{{config("project-status.done")}}" type="radio" class="btn-check" name="status" id="status1" checked>
                                            <label class="btn btn-outline-primary" for="status1">پایان‌یافته</label>
                                            <input value="{{config("project-status.in-progress")}}" type="radio" class="btn-check" name="status" id="status2" @if(old('status') == config("project-status.in-progress")) checked @endif>
