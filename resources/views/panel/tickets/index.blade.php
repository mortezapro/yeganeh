...
@endsection
@section("content")
    <div id="example" data="{{ $data }}" class="content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title d-inline-block">لیست سفارشات</h4>
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title uc-first">حذف تیکت</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>تیکت حذف خواهد شد. آیا مطمئن هستید؟</p>
                </div>
