...
@section("head")
    ...
    <title>فنجان ایرانی | لیست پست ها</title>
@endsection
@section("content")
    <div class="content">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">لیست منوها</li>
                            </ol>
                        </div>
                        <h4 class="page-title d-inline-block">لیست منوها</h4>
                        <a href="{{ route("admin.menu.create") }}" class="btn btn-primary btn-rounded waves-effect waves-light d-inline-block mr-3">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>پست حذف خواهد شد. آیا مطمئن هستید؟</p>
                </div>
