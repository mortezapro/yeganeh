...
@section("head")
    ...
    <title>فنجان ایرانی | ویرایش برند</title>
@endsection
@section("content")
    <div class="content">
        <form action="{{ route("admin.brands.store",["brand" => $brand->slug]) }}" method="post" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title d-inline-block">ویرایش برند</h4>
                                    ...
                                    <div class="tab-pane active" id="main">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                <label for="parent" class="form-label">دسته</label>
                                                <select name="category[]" id="parent" class="form-control" multiple>
                                                    @foreach($categories as $item)
                                                        <option @if($brand->categories->contains($item)) selected @endif value="{{ $item->id }}">{{ $item->title }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-md-12 mb-3">
                                    ...
                                    <div class="tab-pane" id="seo">
                                        <div class="row">
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <input type="text" name="canonical" id="canonical" class="form-control" value="{{ old("canonical",$brand->canonical) }}">
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label for="seo_title" class="form-label">عنوان سئو</label>
                                                <input type="text" name="seo_title" id="seo_title" class="form-control" value="{{ old("seo_title",$brand->seo_title) }}">
                                            </div>
                                            <div class="mb-3 col-md-12">
                                                <label for="seo_description" class="form-label">توضیحات سئو</label>
                                                <textarea type="text" name="seo_description" id="seo_description" class="form-control">{{ old("seo_description",$brand->seo_description) }}</textarea>
                                            </div>
                                            <div class="gallery-preview d-flex justify-content-center" id="seo-image-preview">
                                                <img class="gallery-preview-item" src="{{ asset("seo-images/default")."/".$brand->seo_image }}">
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <input class="form-check-input rounded-circle" type="checkbox" name="indexable" id="indexable" @if($brand->indexable == "بله") checked @endif>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="gallery-preview d-flex justify-content-center" id="thumbnail-preview">
                                    <img class="gallery-preview-item" src="{{ asset("brand-thumbnails/default")."/".$brand->image }}">
                                </div>
                                <div class="mb-3">
