...
@section("head")
    ...
    <title>فنجان ایرانی | لیست صفحات</title>
@endsection
@section("content")
    <div class="content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title d-inline-block">لیست صفحات</h4>
                        <a href="{{ route("admin.page.create") }}" class="btn btn-primary btn-rounded waves-effect waves-light d-inline-block mr-3">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title uc-first">حذف صفحه</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>صفحه حذف خواهد شد. آیا مطمئن هستید؟</p>
                </div>
