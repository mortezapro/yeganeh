...
@section("head")
    ...
    <title>فنجان ایرانی | ویرایش صفحه</title>
@endsection
@section("content")
    <div class="content">
        <form action="{{ route("admin.page.store",["page" => $page->slug]) }}" method="post" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title d-inline-block">ویرایش صفحه</h4>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <select class="form-control" name="layout_id" id="layout">
                                                    <option @if($page->layout_id == 1) selected @endif value="1">لندینگ پیج یک</option>
                                                    <option @if($page->layout_id == 2) selected @endif  value="2">لندینگ پیج دو</option>
                                                    <option @if($page->layout_id == 3) selected @endif  value="3">طرح پیش فرض</option>
                                                    <option @if($page->layout_id == 4) selected @endif  value="4">طرح سفارشی</option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="tab-pane" id="seo">
                                        <div class="row">
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <input type="text" name="canonical" id="canonical" class="form-control" value="{{ old("canonical",$page->canonical) }}">
                                            </div>
                                            <div class="mb-3 col-md-6">
                                            ...
                                            <div class="mb-3 col-md-12">
                                                ...
                                                <textarea type="text" name="seo_description" id="seo_description" class="form-control">{{ old("seo_description",$page->seo_description) }}</textarea>
                                            </div>
                                            <div class="gallery-preview d-flex justify-content-center" id="seo-image-preview">
                                                <img class="gallery-preview-item" src="{{ asset("seo-images/default")."/".$page->seo_image }}">
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <input class="form-check-input rounded-circle" type="checkbox" name="indexable" id="indexable" @if($page->indexable) checked @endif>
                        ...
                        <div class="card ribbon-box">
                            <div class="card-body">
                                ...
                                <div class="ribbon-content">
                                    ...
                                    <div class="mb-3">
                                        <input class="form-check-input rounded-circle" type="checkbox" name="display_header" id="display_header" @if($page->display_header) checked @endif>
                                        <label for="display_header" class="form-label">عدم نمایش header پیش فرض</label>
                                    </div>
                                    <div class="mb-3">
                                        <input class="form-check-input rounded-circle" type="checkbox" name="display_footer" id="display_footer" @if($page->display_footer) checked @endif>
