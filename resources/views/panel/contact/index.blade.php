...
@section("head")
    <title>لیست درخواست‌های ارتباط با ما | {{ env("APP_NAME") }}</title>
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">لیست درخواست‌های ارتباط با ما</li>
                        </ol>
                    </div>
                    <div class="page-title-left">
                        <h4 class="page-title d-inline me-2">لیست درخواست‌های ارتباط با ما</h4>
                    </div>
                </div>
            </div>
        </div>
...
@section("script")
    ...
    <script>
        ...
        var table = $('#datatable').DataTable({
            ...
            "scrollX": true,
            ajax: "{{ route('panel.contacts.index') }}",
            columns: [
