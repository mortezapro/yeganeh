...
@section("content")
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">ویرایش تگ جدید</li>
                        </ol>
                    </div>
                    <div class="page-title-left">
                        <h4 class="page-title d-inline me-2">ایجاد تگ جدید</h4>
                        <a href="{{ route("panel.tags.index") }}" class="btn btn-primary"><i class="fe-list"></i> لیست تگ‌ها</a>
                    </div>
        ...
        <div class="row">
            <form action="{{ route("panel.tags.update",["tag"=> $tag->slug]) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="container-fluid">
                    <div class="row">
                                        ...
                                        <div class="tab-pane active" id="main">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label for="title" class="form-label">عنوان تگ</label>
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <textarea name="content" id="content" class="form-control">{{ old("content",$tag->content) }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="seo">
                                            <div class="row">
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="text" name="canonical" id="canonical" class="form-control" value="{{ old("canonical",$tag->canonical) }}">
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                ...
                                                <div class="mb-3 col-md-12">
                                                    ...
                                                    <textarea type="text" name="seo_description" id="seo_description" class="form-control">{{ old("seo_description",$tag->seo_description) }}</textarea>
                                                </div>
                                                <div class="gallery-preview d-flex justify-content-center" id="seo-image-preview">
                                                    <img class="gallery-preview-item" src="{{ asset("seo-images/default")."/".$tag->seo_image }}">
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    <input class="form-check-input rounded-circle" type="checkbox" name="indexable" id="indexable" @if($tag->indexable) checked @endif value="1" >
