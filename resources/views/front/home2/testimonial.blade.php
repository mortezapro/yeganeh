                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide testimonial-item">
                        <div class="testimonial-item-body">
                            <img class="animation-slide-right bg-shape" src="{{ asset("theme/synck/assets/imgs/bg-shape-3.svg") }}" alt="Shape"/>
                            <span class="platform-name">
                                        <img src="{{ asset("theme/synck/assets/imgs/icon-linkedin.svg") }}" alt="Icon"/>
                                    </span>
                            ...
                            <div class="author-box d-flex align-items-center">
                                <img src="{{ asset("theme/synck/assets/imgs/testimonial-1.jpg") }}" alt="Testimonial"/>
                    ...
                    <div class="swiper-slide testimonial-item">
                        <div class="testimonial-item-body">
                            <img class="bg-shape" src="{{ asset("theme/synck/assets/imgs/bg-shape-3.svg") }}" alt="Shape"/>
                            <span class="platform-name">
                                        <img src="{{ asset("theme/synck/assets/imgs/icon-linkedin.svg") }}" alt="Icon"/>
                                    </span>
                            ...
                            <p>One aspect that sets IT Services apart is their proactive approach to security. In today's digital landscape, protecting our sensitive data is of utmost importance.</p>
                            <div class="author-box d-flex align-items-center">
                                <img src="{{ asset("theme/synck/assets/imgs/testimonial-2.jpg") }}" alt="Testimonial"/>
                                <div class="author-box-content">
                                    <h4>Megan Clarke</h4>
                                    <p>CEO, Sanlab</p>
                                </div>
                    ...
                    <div class="swiper-slide testimonial-item">
                        <div class="testimonial-item-body">
                            ...
                            <p>One aspect that sets IT Services apart is their proactive approach to security. In today's digital landscape, protecting our sensitive data is of utmost importance.</p>
                            <div class="author-box d-flex align-items-center">
                                <img src="{{ asset("theme/synck/assets/imgs/testimonial-3.jpg") }}" alt="Testimonial"/>
                                <div class="author-box-content">
                                    <h4>Rachel Olsem</h4>
