    ...
    <div class="custom-container">
        ...
        <div class="services-list d-flex">
            <div class="service-card simple-shadow">
                <img src="{{ asset("theme/synck/assets/imgs/service-icon-1.svg") }}" alt="Service Icon" class="service-icon" />
                <h3><a href="./service-details.html">Development</a></h3>
                <p>Our development is pixel perfect in all ways.</p>
            </div>
            <div class="service-card simple-shadow">
                <img src="{{ asset("theme/synck/assets/imgs/service-icon-2.svg") }}" alt="Service Icon" class="service-icon" />
                <h3><a href="./service-details.html">Woo Commerce</a></h3>
                <p>We have a best team for your shopping websites.</p>
            </div>
            <div class="service-card simple-shadow">
                <img src="{{ asset("theme/synck/assets/imgs/service-icon-3.svg") }}" alt="Service Icon" class="service-icon" />
                <h3><a href="./service-details.html">CRM Solutions</a></h3>
                <p>We enhance customer experiences for success.</p>
            </div>
            <div class="service-card simple-shadow">
                <img src="{{ asset("theme/synck/assets/imgs/service-icon-4.svg") }}" alt="Service Icon" class="service-icon" />
            ...
            <div class="service-card simple-shadow">
                ...
                <img src="{{ asset("theme/synck/assets/imgs/service-icon-5.svg") }}" alt="Service Icon" class="service-icon" />
