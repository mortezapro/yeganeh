<section class="project-area ltr">
                            ...
                            <div class="swiper-slide project-item">
                                <div class="project-item-inner">
                                    <h2><a href="portfolio-details.html">E-commerce <br>
                                            platform <br>
                                            development.</a></h2>
                                    <img src="{{ asset("theme/synck/assets/imgs/project-1.png") }}" alt="Project"/>
                                </div>
                            </div>
                            <div class="swiper-slide project-item">
                                <div class="project-item-inner">
                                    <h2><a href="portfolio-details.html">Software as a <br>
                                            Service <br>
                                            integration</a></h2>
                                    <img src="{{ asset("theme/synck/assets/imgs/project-2.png") }}" alt="Project"/>
                                </div>
                            </div>
                            <div class="swiper-slide project-item">
                                <div class="project-item-inner">
                                    <h2><a href="portfolio-details.html">Mobile <br>
                                            Platform <br>
                                            Development</a></h2>
                                    <img src="{{ asset("theme/synck/assets/imgs/project-3.png") }}" alt="Project"/>
                                </div>
                            </div>
                            <div class="swiper-slide project-item">
                                <div class="project-item-inner">
                                    <h2><a href="portfolio-details.html">
                                            ...
                                            Virtual Reality <br>
                                            World.</a></h2>
                                    <img src="{{ asset("theme/synck/assets/imgs/project-4.png") }}" alt="Project"/>
                                </div>
                            </div>
                            <div class="swiper-slide project-item">
                                <div class="project-item-inner">
                                    <h2><a href="portfolio-details.html">
                                            ...
                                            system for a <br>
                                            sales team.</a></h2>
                                    <img src="{{ asset("theme/synck/assets/imgs/project-5-new.png") }}" alt="Project"/>
                                </div>
                            </div>
                            <div class="swiper-slide project-item">
                                <div class="project-item-inner">
                                    <h2><a href="portfolio-details.html">
                                            ...
                                            For Your <br>
                                            Productivity.</a></h2>
                                    <img src="{{ asset("theme/synck/assets/imgs/project-6-new.png") }}" alt="Project"/>
                                </div>
                            </div>
                        </div>
