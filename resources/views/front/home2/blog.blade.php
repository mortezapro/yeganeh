    ...
    <div class="custom-container">
        ...
        <div class="sticky-news d-flex card-h">
            <div class="news-img-box">
                <img src="{{ asset("theme/synck/assets/imgs/news-1.jpg") }}" alt="News"/>
            </div>
        ...
        <div class="news-items d-flex align-items-start">
            ...
            <div class="news-item card-h">
                <div class="news-img-box">
                    <img src="{{ asset("theme/synck/assets/imgs/news-2.jpg") }}" alt="News"/>
                </div>
            ...
            <div class="news-item card-h">
                <div class="news-img-box">
                    <img src="{{ asset("theme/synck/assets/imgs/news-3.jpg") }}" alt="News"/>
                </div>
                <div class="news-item-body">
