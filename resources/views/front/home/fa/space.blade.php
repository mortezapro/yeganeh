<div class="xc-header-banner__section text-center pt-60 pb-100">
    <div class="xc-header-banner__bg">
        <img src="{{ asset("theme/xaito/assets/img/shapes/hero-bg-1.png") }}" alt="">
    </div>
    <div class="xc-header-banner__shape">
        <div class="shape-1">
            <img src="{{ asset("theme/xaito/assets/img/round-rock.png") }}" alt="">
        </div>
        <div class="shape-2">
            <img src="{{ asset("theme/xaito/assets/img/slim-rock.png") }}" alt="">
        </div>
        <div class="shape-3">
            <img src="{{ asset("theme/xaito/assets/img/lend-rock.png") }}" alt="">
        </div>
    </div>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-10 col-md-12 col-xl-7 co-sm-12 col-xxl-6 intro-content">
                <div class="xc-header-banner__title-wrapper wow xcfadeUp">
                    ...
                    {{--                                <span class="xc-header-banner__tag"> از تصمیم‌گیری‌های مبتنی بر حدس و گمان خداحافظی کنید</span>--}}
                    {{--                                <span class="xc-header-banner__tag"> بگذارید اسنادتان برای شما کار کنند</span>--}}
                    {{--                                <span class="xc-header-banner__tag"> کشف ارزش پنهان در اسنادتان، تنها با یک کلیک</span>--}}
        ...
        {{--<div class="row">
            <div class="xc-header-banner__img w-img p-relative wow xcfadeUp">
                <img src="{{ asset("theme/xaito/assets/img/resourse/banner-img-1.jpg") }}" alt="">
                <div class="xc-header-banner__video xc-video-1">
                    <a class="xc-popup-video" href="https://www.youtube.com/watch?v=wGWVKkYEHBE"><i
